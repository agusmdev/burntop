  ...
  return (
    <SheetPortal>
      ...
      <SheetPrimitive.Content
        ...
        className={cn(
          'fixed z-50 flex flex-col shadow-xl transition ease-in-out',
        ...
        {showCloseButton && (
          <SheetPrimitive.Close
            className={cn(
              ...
              'focus:outline-none focus:ring-2 focus:ring-ember-500 focus:ring-offset-2 focus:ring-offset-sidebar',
